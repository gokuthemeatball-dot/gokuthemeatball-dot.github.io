const CACHE_NAME='aisle13-app-v107';
const APP_SHELL=[
  './',
  './index.html',
  ...
  './death-sound-effect.mp3?v=72',
  './close-by-sound.mp3?v=73',
  './jump-sound.mp3?v=74',
  './surprise-sound.mp3?v=75',
  './question-sound.mp3?v=77',
  './speaker-sound-1.mp3?v=78',
  './speaker-sound-2.mp3?v=78',
  './speaker-sound-3.mp3?v=78',
  './speaker-sound-es-1.mp3?v=80',
  './speaker-sound-es-2.mp3?v=80',
  './speaker-sound-es-3.mp3?v=80'
];
